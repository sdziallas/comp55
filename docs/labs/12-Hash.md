...
Click [here](https://docs.oracle.com/javase/8/docs/api/java/util/HashMap.html)
for more information on ```HashMap``` and
[here](https://docs.oracle.com/javase/8/docs/api/java/util/Hashtable.html)
